...
const service = {
    ...
    deleteItem: deleteRepresentative,
    deleteMultiple: deleteRepresentativeMultiple
};
...
<template>
    <div>
        <GenericTable
            ...
            titleTable="Listado de Representative"
            :selectableRows="true"
        ...
        >
            ...
            <template #row-actions="{ row }">
                <Button
                    ...
                    as="router-link"
                    title="Ver detalles"
                    :to="{ name: 'show_representative', params: { id: row.id } }"
                ...
                <Button
                    ...
                    as="router-link"
                    title="Editar"
                    :to="{ name: 'edit_representative', params: { id: row.id } }"
